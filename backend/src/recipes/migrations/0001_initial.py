    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное время приготовления 1 минута'), django.core.validators.MaxValueValidator(32000, message='Максимальное время приготовления 32000 минут')], verbose_name='Время приготовления (в минутах)')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['name'], name='recipes_ing_name_37e3e7_idx'),
        ),
